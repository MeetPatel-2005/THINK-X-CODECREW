    ...
    <div className="w-full h-screen flex px-20 py-10 bg-blue-200/50">
      <div className="w-[48%] h-full border relative rounded-3xl overflow-hidden">
        ...
        <div className="absolute bottom-10 left-10 flex flex-col gap-4">
          <h1 className="text-white font-bold text-[80px] tracking-tighter leading-none mb-6">
            Join Your Academic Community
          </h1>
          <p className="text-white leading-none max-w-xl text-2xl">
            Sign up to explore your learning resources, track your academic
      ...
      <div className="w-1/2 h-full border rounded-3xl overflow-hidden p-30 flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-xl text-zinc-500">Sign up to access your personalized dashboard and resources.</p>
        </div>
        <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          <p className="text-lg font-medium text-zinc-900">Confirm Password</p>
          <div className="relative">
            <input type={showConfirmPassword ? "text" : "password"} placeholder="Confirm your password" className="outline-none px-4 py-2 text-lg border border-zinc-400/30 rounded-lg w-full pr-12" />
            <button
              type="button"
        ...
        <div className="flex flex-col gap-2 justify-center items-center">
          <p className="text-lg text-zinc-500 font-regular">
           Already have an account? <a href="/login" className="text-zinc-700 hover:text-blue-500 transition-all duration-100 ease-in-out">Sign In</a>
          </p>
        </div>
      </div>
    </div>
